...
def lb():
	...
	print('Balanceador de carga configurado y funcionando!!\n\n')
        print('Abra un nuevo terminal si necesita conectarse a alguna de las maquinas o si quiere destruir el escenario\n')

def help():
        print('Configurar y arrancar todo: sudo python installPfinal.py doItAll\n')
        print('Configurar un numero de servidores mayor que 3: sudo python installPfinal.py create [nServ]\n')
